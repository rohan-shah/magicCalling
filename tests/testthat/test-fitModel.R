...
test_that("Testing first marker",
{
	...
	suppressWarnings(capture.output(clusterModel <- do.call(fitClusterModel, c(list(data = data, startingPoints = startingPoints, n.iter = 200), magicCalling:::exampleModelParameters))))
